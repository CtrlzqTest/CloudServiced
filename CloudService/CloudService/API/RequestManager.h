...
+ (void)downloadFileRquestWithFileUrl:(NSString *)fileUrl progress:(void(^)(NSProgress *)) completionHandler:(void(^)(id responseObject)) completionHandler failerHandler:(void(^)(NSError *error))failerHandler;
