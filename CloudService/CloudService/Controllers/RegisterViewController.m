...
//        [dict setValue:self.codeText.text forKey:@"code"];
        ...
        [MHNetworkManager postReqeustWithURL:[RequestEntity urlString:kRegisterAPI] params:@{@"phoneNo":@"12245628909",@"password":@"123456",@"address":@"0102",@"code":@"123456"} successBlock:^(id returnData) {
